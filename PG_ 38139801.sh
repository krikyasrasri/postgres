...
then
 ...
 $WGET  --load-cookies="$COOKIE_FILE" "https://updates.oracle.com/Orion/Services/download/p38139801_23902507OGGRU_Linux-x86-64.zip?aru=27641487&patch_file=p38139801_23902507OGGRU_Linux-x86-64.zip" -O "$OUTPUT_DIR/p38139801_23902507OGGRU_Linux-x86-64.zip"   >> "$LOGFILE" 2>&1 
